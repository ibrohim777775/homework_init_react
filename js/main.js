        ...
        for (let i = 0; i < res.results.length; i++) {
            let element = `
               <div class="movies_card">
                    ...
                    <p class="movies_date">${dateToString(res.results[i].release_date)}</p >
                    <div class="progres">
...
fetch(popularOnTv)
    ...
    .then(function (popTv) {
        ...
        for (let i = 0; i < popTv.results.length; i++) {
            let elem = `
                <div div class="movies_card" >
                    <a href="#" class="movies_more">...</a>
                    <img src="https://image.tmdb.org/t/p/w185/${popTv.results[i].poster_path}" alt="movie" class="movies_bg" width="150px" height="230px">
                    <h4 class="movies_title">${popTv.results[i].name}</h4>
                    <p class="movies_date">${dateToString(popTv.results[i].first_air_date)}</p>
                    <div class="progres">
                        <div class="radial-progress" data-progress="${popTv.results[i].vote_average * 10}">
                            <div class="circle">
                                <div class="mask full">
                                    <div class="fill"></div>
                                </div>
